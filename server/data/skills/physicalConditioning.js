export default {
  ...
  isSkillTree: true,
  traits: [
    {name: "Muscular", effect: {text: "Gain +1 to all lift/drag/push skill checks.", skillBoosts: ["Lift/Drag/Push"]}},
    {name: "Stubborn Tenacity", effect: {text: "Gain +1 to all hold breath and remain conscious skill checks.", skillBoosts: ["Hold Breath", "Remain Conscious"]}},
    {name: "Staying Power", effect: {text: "Gain +1 to all endurance skill checks", skillBoosts: ["Endurance"]}},
    {name: "High Vitality", effect: {text: "Gain +1 stamina.", attributeBoost: ["Stamina"]}},
    {name: "Speedy Recovery", effect: {text: "Recover +1 stamina when you take the Restoration Action combat action"}},
    {name: "Peak Health", cost: [5, 13], effect: {text: "Gain +1 max wounds.", attributeBoost: ["Wounds"]}}
