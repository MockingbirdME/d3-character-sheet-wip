export default {
  ...
  isSkillTree: true,
  traits: [
    {name: "Gentle Touch", effect: {text: "Gain +1 to all pick locks skill checks.", skillBoosts: ["Pick Locks"]}},
    {name: "Fast Hands", effect: {text: "Gain +1 to all slight of hand skill checks.", skillBoosts: ["Slight of Hand"]}},
    {name: "Subtle Speech", effect: {text: "Gain +1 to all thieves cant skill checks", skillBoosts: ["Thieves Cant"]}},
    {name: "Quick Draw", effect: {text: "Reduce the speed of your ready/stow actions by 2, once reduced to 0 additional instances of this trait allow you to perform one ready/stow action each turn for 0 action points."},alwaysDisplay: true},
