export default animalHandling = {
  ...
  traits: [
    ...
    {name: "Smell\'s like my Trainer", effect: {text: "When attempting to interact with a trained animal you may spend one permanent willpower to reroll one die in your Animal Handling skill check"}, costs: [2]},
    {name: "One with Nature", effect: {text: "When attempting to interact with a wild animal you may spend one permanent willpower to reroll one die in your Animal Handling skill check"}, costs: [3]},
